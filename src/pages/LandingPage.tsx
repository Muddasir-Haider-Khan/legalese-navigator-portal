    ...
    <Layout>
      <div className={`w-full transition-all duration-700 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
        ...
        <section className="py-16 md:py-24 bg-rocket-gray-50 dark:bg-rocket-gray-800/30">
          <div className="container-custom">
            <div className="text-center mb-12">
              <span className="text-rocket-orange-500 font-medium mb-2 block">How It Works</span>
            ...
            <div className="grid md:grid-cols-3 gap-8 md:gap-12">
              <div className="text-center">
                <div className="bg-rocket-orange-50 dark:bg-rocket-orange-900/20 h-16 w-16 rounded-full flex items-center justify-center mx-auto mb-4 relative">
                  <FileText className="h-8 w-8 text-rocket-orange-500 dark:text-rocket-orange-300" />
                  <span className="absolute -top-2 -right-2 bg-rocket-orange-500 text-white h-6 w-6 rounded-full flex items-center justify-center text-sm font-medium">
                    1
                  </span>
                </div>
              ...
              <div className="text-center">
                <div className="bg-rocket-orange-50 dark:bg-rocket-orange-900/20 h-16 w-16 rounded-full flex items-center justify-center mx-auto mb-4 relative">
                  <CheckCircle className="h-8 w-8 text-rocket-orange-500 dark:text-rocket-orange-300" />
                  <span className="absolute -top-2 -right-2 bg-rocket-orange-500 text-white h-6 w-6 rounded-full flex items-center justify-center text-sm font-medium">
                    2
                  </span>
                </div>
              ...
              <div className="text-center">
                <div className="bg-rocket-orange-50 dark:bg-rocket-orange-900/20 h-16 w-16 rounded-full flex items-center justify-center mx-auto mb-4 relative">
                  <Shield className="h-8 w-8 text-rocket-orange-500 dark:text-rocket-orange-300" />
                  <span className="absolute -top-2 -right-2 bg-rocket-orange-500 text-white h-6 w-6 rounded-full flex items-center justify-center text-sm font-medium">
                    3
                  </span>
                </div>
            ...
            <div className="mt-12 text-center">
              <Link to="/how-it-works">
                <Button variant="outline" className="border-rocket-orange-500 text-rocket-orange-500 hover:bg-rocket-orange-50 dark:border-rocket-orange-400 dark:text-rocket-orange-400 dark:hover:bg-rocket-orange-900/20">
        ...
        <section className="py-16 md:py-24 bg-white dark:bg-rocket-gray-900">
          <div className="container-custom">
            <div className="text-center mb-12">
              <span className="text-rocket-orange-500 font-medium mb-2 block">Popular Documents</span>
              <h2 className="text-3xl md:text-4xl font-bold mb-4 text-rocket-gray-900 dark:text-white">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-10">
              <Link to="/documents/will" className="bg-white dark:bg-rocket-gray-800 border border-rocket-gray-200 dark:border-rocket-gray-700 rounded-lg p-4 text-center hover:shadow-md transition-shadow">
                <FileText className="h-8 w-8 mx-auto mb-2 text-rocket-orange-500 dark:text-rocket-orange-300" />
            ...
            <div className="text-center">
              <Link to="/documents">
                <Button className="bg-rocket-orange-500 hover:bg-rocket-orange-600 text-white shadow-md">
