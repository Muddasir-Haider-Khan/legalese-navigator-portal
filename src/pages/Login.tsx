            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <div>
                ...
                <Input
                  ...
                  className="mt-1 bg-black/20 border-gray/30 text-black placeholder-rocket-gray-300"
                  required
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <Input
                    ...
                    className="mt-1 pr-10 bg-black/20 border-gray/30 text-black placeholder-rocket-gray-300"
                    required
                  />
                  <button
                    type="button"
