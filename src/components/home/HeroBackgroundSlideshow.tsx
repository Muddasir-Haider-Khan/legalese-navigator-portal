          ...
          {images.map((image, index) => (
            <CarouselItem key={index} className="h-full">
              <div className="relative h-full w-full transition-all duration-700 transform">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-br from-rocket-blue-600/60 to-rocket-blue-900/60 transition-opacity duration-700 ease-in-out backdrop-blur-[2.8px]"></div>
              </div>
            </CarouselItem>
          ))}
        </CarouselContent>
